...
function startFeedbackProcess_ButFirst() {
    
    var mainCell = document.getElementsByClassName('main-cell').item(0);
    var oldFrame = mainCell.firstChild;
    var newframe = document.createElement('iFrame');

    newframe.src = 'but_first.html';

    mainCell.removeChild(oldFrame);
    mainCell.appendChild(newframe);
}
